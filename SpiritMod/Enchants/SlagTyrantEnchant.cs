...
namespace ResonantSouls.SpiritMod.Enchants
{
    ...
    public class SlagTyrantEnchant : BaseEnchant
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = ModContent.GetInstance<ObsidiusHelm>().Item.value + ModContent.GetInstance<ObsidiusPlate>().Item.value + ModContent.GetInstance<ObsidiusGreaves>().Item.value + ModContent.GetInstance<TheFireball>().Item.value + ModContent.GetInstance<FieryMagicLauncher>().Item.value + ModContent.GetInstance<FierySummonStaff>().Item.value + ModContent.GetInstance<HellEater>().Item.value;
        }
