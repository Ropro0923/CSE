...
namespace ResonantSouls.SpiritMod.Enchants
{
    ...
    public class ChitinEnchant : BaseEnchant
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = ModContent.GetInstance<ChitinHelmet>().Item.value + ModContent.GetInstance<ChitinChestplate>().Item.value + ModContent.GetInstance<ChitinLeggings>().Item.value + ModContent.GetInstance<Hummus>().Item.value + ModContent.GetInstance<ChitinAxe>().Item.value + ModContent.GetModItem(ModCompatibility.SpiritMod.Mod.Find<ModItem>("GildedScarab").Type).Item.value;
        }
